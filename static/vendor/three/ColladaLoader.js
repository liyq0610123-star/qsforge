...
// TGA textures are not used in DDC-produced DAE files. Inline a stub instead
// of bundling another vendor file just to satisfy the import.
class TGALoader extends Loader {
	load( url, onLoad, onProgress, onError ) {
		if ( onError ) onError( new Error( 'TGALoader stubbed in ArchiQS Viewer3D' ) );
	}
	setPath() { return this; }
}
